...
/**
 * AGENTS.md Generation Script
 * 
 * Generates AGENTS.md from CLAUDE.md architectural specification
...
class AgentsGenerator {
  ...
  async generate() {
    try {
      console.log('🚀 Starting AGENTS.md generation from CLAUDE.md...');
      
      // Load template
      const template = this.loadTemplate();
      
      // Analyze CLAUDE.md architecture
      await this.analyzeClaude();
  ...
  loadTemplate() {
    console.log('📄 Loading AGENTS template...');
  ...
  async analyzeClaude() {
    console.log('📊 Analyzing CLAUDE.md architecture...');
    ...
    if (fs.existsSync(this.claudeFile)) {
      claudeContent = fs.readFileSync(this.claudeFile, 'utf8');
    } else {
      console.warn('⚠️  CLAUDE.md not found, using fallback content');
    }
    
    // Extract architectural guidance and convert to implementation instructions
    this.extractArchitecturalGuidance(claudeContent);
    
    console.log('✅ Architecture analysis completed');
  }

  extractArchitecturalGuidance(claudeContent) {
    // Generate implementation instructions based on CLAUDE.md architecture
    this.placeholders.set('projectOverview', this.generateProjectOverview(claudeContent));
    this.placeholders.set('architecturalImplementationRequirements', this.generateArchitecturalRequirements(claudeContent));
    this.placeholders.set('reactStandards', this.generateReactStandards());
    this.placeholders.set('storybookRequirements', this.generateStorybookRequirements());
    this.placeholders.set('designSystemStandards', this.generateDesignSystemStandards());
    this.placeholders.set('architectureDrivenDevelopment', this.generateArchitectureDrivenDevelopment());
    this.placeholders.set('implementationCommands', this.generateImplementationCommands());
    this.placeholders.set('implementationRules', this.generateImplementationRules());
    this.placeholders.set('reactTypeScriptImplementation', this.generateReactTypeScriptImplementation());
    this.placeholders.set('cssImplementationStandards', this.generateCssImplementationStandards());
    this.placeholders.set('storybookImplementation', this.generateStorybookImplementation());
    this.placeholders.set('fileOrganizationImplementation', this.generateFileOrganizationImplementation());
    this.placeholders.set('testingImplementationPrinciples', this.generateTestingImplementationPrinciples());
    this.placeholders.set('unitTestingImplementation', this.generateUnitTestingImplementation());
    this.placeholders.set('testingImplementationRequirements', this.generateTestingImplementationRequirements());
    this.placeholders.set('implementationQualityGates', this.generateImplementationQualityGates());
    this.placeholders.set('coreTechnologyImplementation', this.generateCoreTechnologyImplementation());
    this.placeholders.set('buildSystemImplementation', this.generateBuildSystemImplementation());
    this.placeholders.set('deploymentImplementation', this.generateDeploymentImplementation());
    this.placeholders.set('componentImplementationRequirements', this.generateComponentImplementationRequirements());
    this.placeholders.set('architectureComplianceCheck', this.generateArchitectureComplianceCheck());
    this.placeholders.set('componentImplementationTemplate', this.generateComponentImplementationTemplate());
    this.placeholders.set('stylingImplementation', this.generateStylingImplementation());
    this.placeholders.set('storybookComponentImplementation', this.generateStorybookComponentImplementation());
    this.placeholders.set('testingComponentImplementation', this.generateTestingComponentImplementation());
    this.placeholders.set('frsDocumentationRequirements', this.generateFrsDocumentationRequirements());
    this.placeholders.set('integrationImplementation', this.generateIntegrationImplementation());
    this.placeholders.set('componentCategoriesImplementation', this.generateComponentCategoriesImplementation());
    ...
    this.placeholders.set('implementationProcess', this.generateImplementationProcess());
    this.placeholders.set('qualityAssuranceImplementation', this.generateQualityAssuranceImplementation());
    this.placeholders.set('frsDocumentationProcess', this.generateFrsDocumentationProcess());
    this.placeholders.set('implementationTroubleshooting', this.generateImplementationTroubleshooting());
    this.placeholders.set('implementationSuccessCriteria', this.generateImplementationSuccessCriteria());
    this.placeholders.set('frsContentGeneration', this.generateFrsContentGeneration());
    this.placeholders.set('technicalSpecificationsCapture', this.generateTechnicalSpecificationsCapture());
    this.placeholders.set('implementationArtifactsDocumentation', this.generateImplementationArtifactsDocumentation());
    this.placeholders.set('primeDirective', this.generatePrimeDirective());
  }

  generateProjectOverview(claudeContent) {
    return `This is a React Design System project following the Architect Crew methodology. The architecture is defined in CLAUDE.md and must be implemented exactly as specified.
...
- CSS Modules for component styling`;
  ...
  generateArchitecturalRequirements(claudeContent) {
    return `### Mandatory Architecture Implementation
...
- Unit tests with 90%+ coverage`;
  ...
  generateReactStandards() {
    return `### React Implementation Standards
...
- Consistent prop naming conventions`;
  ...
  generateStorybookRequirements() {
    return `### Storybook Implementation Requirements
...
- Documentation descriptions`;
  ...
  generateDesignSystemStandards() {
    return `### Design System Implementation Standards
...
- Event handlers with \`on\` prefix`;
  ...
  generateArchitectureDrivenDevelopment() {
    return `### Architecture-Driven Development Process
...
- Performance budget compliance`;
  ...
  generateImplementationCommands() {
    return `### Essential Implementation Commands
...
\`\`\``;
  ...
  generateImplementationRules() {
    return `### Mandatory Implementation Rules
...
- Explicit imports (no \`import *\`)`;
  ...
  generateReactTypeScriptImplementation() {
    return `### React + TypeScript Implementation Standards
...
\`\`\``;
  ...
  generateCssImplementationStandards() {
    return `### CSS Implementation Standards
...
- Use logical properties where possible`;
  ...
  generateStorybookImplementation() {
    return `### Storybook Implementation Requirements
...
- Comprehensive documentation`;
  ...
  generateFileOrganizationImplementation() {
    return `### File Organization Implementation
...
\`\`\``;
  ...
  generateTestingImplementationPrinciples() {
    return `### Testing Implementation Principles
...
- Mock external dependencies`;
  ...
  generateUnitTestingImplementation() {
    return `### Unit Testing Implementation
...
- Mock external dependencies properly`;
  ...
  generateTestingImplementationRequirements() {
    return `### Testing Implementation Requirements
...
\`\`\``;
  ...
  generateImplementationQualityGates() {
    return `### Implementation Quality Gates
...
\`\`\``;
  ...
  generateCoreTechnologyImplementation() {
    return `### Core Technology Implementation
...
\`\`\``;
  ...
  generateBuildSystemImplementation() {
    return `### Build System Implementation
...
\`\`\``;
  ...
  generateDeploymentImplementation() {
...
\`\`\``;
  ...
  generateComponentImplementationRequirements() {
    return `### Component Implementation Requirements
...
5. Review integration points`;
  ...
  generateArchitectureComplianceCheck() {
    return `### Architecture Compliance Check
...
\`\`\``;
  ...
  generateComponentImplementationTemplate() {
    return `### Component Implementation Template
...
\`\`\``;
  ...
  generateStylingImplementation() {
    return `### Component Styling Implementation
...
- Follow consistent naming patterns`;
  ...
  generateStorybookComponentImplementation() {
    return `### Storybook Component Implementation
...
- Include performance notes`;
  ...
  generateTestingComponentImplementation() {
    return `### Component Testing Implementation
...
- Achieve 90%+ code coverage`;
  ...
  generateFrsDocumentationRequirements() {
    return `### FRS Documentation Requirements
...
\`\`\``;
  ...
  generateComponentCategoriesImplementation() {
    return `### Component Categories Implementation
...
- Monitor runtime performance metrics`;
  ...
  generateImplementationProcess() {
    return `### Implementation Process Workflow
...
- Before release: Cross-browser testing complete`;
  ...
  generateQualityAssuranceImplementation() {
...
- [ ] Accessibility features are complete`;
  ...
  generateFrsDocumentationProcess() {
    return `### FRS Documentation Process
...
- Stakeholder notification of updates`;
  ...
  generateImplementationTroubleshooting() {
    return `### Implementation Troubleshooting
...
- Contact design system team for support`;
  ...
  generateImplementationSuccessCriteria() {
    return `### Implementation Success Criteria
...
- Adoption rate: Component usage in applications`;
  ...
  generateFrsContentGeneration() {
    return `### FRS Content Generation Requirements
...
- Accessibility audit results`;
  ...
  generateTechnicalSpecificationsCapture() {
    return `### Technical Specifications to Capture
...
- Troubleshooting documentation`;
  ...
  generateImplementationArtifactsDocumentation() {
    return `### Implementation Artifacts to Document
...
- Maintenance and update procedures`;
  ...
  generatePrimeDirective() {
    return `### Prime Directive for Implementation
...
**This prime directive overrides all other considerations and must guide every implementation decision.**`;
  ...
  substitutePlaceholders(template) {
    ...
    if (frontMatterMatch) {
      ...
      frontMatter = frontMatter.replace(/\{\{agentsVersion\}\}/g, this.agentsVersion);
...
if (require.main === module) {
  ...
  const generator = new AgentsGenerator(options);
  generator.generate();
}
